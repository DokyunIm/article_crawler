...
def get(url):
    ...
    if(status==200):
        ...
        article_title = soup.select("#article_title") # 기사 제목
        article_regdate = soup.select(".article_head > .clearfx > .byline > em") # 기사 등록일
        article_content = soup.select("#article_body") # 기사 본문
